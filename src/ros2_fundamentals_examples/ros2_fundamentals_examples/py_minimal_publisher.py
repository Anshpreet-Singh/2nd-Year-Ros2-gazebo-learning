...
"""
Description:
    This ROS2 node periodically publishes "Hello World" messages

-----------
Publishing Topics:
    The channel containing the "Hello World" messages
    /py_example_topics - std_msgs/String
...
class MinimalPyPublisher(Node):
    ...
    def __init__(self):
        ...
        #Initialize a counter variable for message count
        self.i = 0

    def timer_callback(self):
        """Callback function executed periodically by the times
        """
...
def main(args=None):
    ...
    #Create an instance of the minimal Publsiher Node
    minmal_py_publisher=MinimalPyPublisher()

    rclpy.spin(minmal_py_publisher)

    #Destroy the node explicity
    minmal_py_publisher.destroy_node()
